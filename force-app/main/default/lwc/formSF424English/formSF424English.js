...
import { OMNIDEF } from './formSF424English_def.js';
import tmpl from './formSF424English.html';
import tmpl_nds from './formSF424English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class formSF424English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
