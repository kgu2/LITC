...
import { OMNIDEF } from './form13424English_def.js';
import tmpl from './form13424English.html';
import tmpl_nds from './form13424English_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class form13424English extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
