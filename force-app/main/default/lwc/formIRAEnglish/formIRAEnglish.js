...
import { OMNIDEF } from './formIRAEnglish_def.js';
import tmpl from './formIRAEnglish.html';
import tmpl_nds from './formIRAEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class formIRAEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
